...
class VerificationPage extends StatelessWidget {
  static Route<dynamic> route({
    required VerificationParams params,
    RouteSettings? settings,
      ...
      MaterialPageRoute(
        ...
        builder: (context) => VerificationPage(
          ...
          forgetPasswordPage: params.forgetPasswordPage,
        ),
      );
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        bottom: PreferredSize(
          ...
          child:
              Container(color: Colors.grey.withValues(alpha: 0.3), height: 1.h),
        ),
      ),
        ...
        child: Column(
          ...
          children: [
            ...
            if (forgetPasswordPage) ...[
              Text(
                "verification_code_to_change_password".tr,
                ...
                listener: (context, state) {
                  ...
                  if (state.verifyOtpSuccessfully) {
                    Navigator.of(context).pushNamed(
                        RoutePath.forgetPasswordRoute,
                        arguments: RestPasswordParams(
                            fullPhone: fullPhone, token: state.token!));
                  }
                  ...
                  return CustomButton(
                    ...
                    onTap: () {
                      if (state.otp == null || state.otp!.length != 4) {
                        ...
                        if (forgetPasswordPage) {
                          verificationCubit.verifyOtp(fullPhone);
                        } else {
