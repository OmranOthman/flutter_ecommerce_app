...
class VerifyChangePasswordPage extends StatelessWidget {
  static Route<dynamic> route({
    ...
    RouteSettings? settings,
      ...
      MaterialPageRoute(
        settings: settings,
        builder: (context) => VerifyChangePasswordPage(fullPhone: params),
      );

  final String fullPhone;

  const VerifyChangePasswordPage({super.key, required this.fullPhone});
                  ...
                  return CustomButton(
                    ...
                    onTap: () {
                      if (state.otp == null || state.otp!.length != 4) {
                        showSnackBar(
                            context, msg: "please_fill_in_the_fields".tr);
                      } else {
