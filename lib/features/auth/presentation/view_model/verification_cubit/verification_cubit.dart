...
class VerificationCubit extends Cubit<VerificationState> {
  ...
  Future<void> verifyOtp(String fullPhone) async {
    emit(state.copyWith(isLoading: true));

    ApiResult<String, Failure> result =
        await authRepository.verifyOtp(fullPhone: fullPhone, otp: state.otp!);
