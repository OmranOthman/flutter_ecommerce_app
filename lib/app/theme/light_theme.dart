...
import 'package:flutter_ecommerce_app/app/theme/app_bar_theme.dart';
...
class LightThemeMode {
  static ThemeData buildLightTheme(BuildContext context,
    ...
    final textTheme = TextThemeMode.buildTextTheme(
    ...
    const IconThemeData iconThemeData =
        IconThemeData(color: AppColors.lightModeWhiteColor, size: 24);

    return base.copyWith(
      appBarTheme: AppBarThemeCustom.buildLightAppBarTheme(),
